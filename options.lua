return {
  ...
  g = {
    ...
    heirline_theme = "minimal", -- set heirline statusline theme (possible options are doom, lunarvim, minimal, nvchad, simple), comment/remove this option to choose default astronvim statusline
